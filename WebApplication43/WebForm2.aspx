<%@ Master Language="C#" AutoEventWireup="true" CodeBehind="Site3.master.cs" Inherits="WebApplication43.Site3" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            ...
                            <ul class="ms-auto d-inline-flex">
                                <li class="p-2"><a target="_blank" href="">
                                    <asp:Button ID="Button1" runat="server" BackColor="#990000" ForeColor="White" OnClick="Button1_Click" Text="Home" Width="92px" />
                                    </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container">
                  ...
                  <a class="text-white" data-bs-target="#menu" data-bs-toggle="collapse" aria-expanded="false" aria-controls="menu"><i class="bi cp bi-list float-end fs-1 dmji"></i></a> 
                    ...
                    <ul id="menu" class=" navcol fw-bold d-none d-md-inline-flex">
                        <li class="p-21 px-4"><a class="text-white" href="categoryadd.aspx">Add categories </a> <%--<i class="bi pt-2 bi-chevron-down">--%></i>
                           <%-- <div class="inner-div">
                                <ul class="">
                                    <li><a href="">Baby</a></li>
                          ...
                          <li class="p-21 px-4"><a class="text-white" href="categoryview.aspx">View/ Edit Categories <%--<i class="bi pt-2 bi-chevron-down">--%></i>
                           <%-- <div class="inner-div">
                                <ul class="">
                        ...
                        <li class="p-21 px-4"><a class="text-white" href="productadd.aspx">Add Products <%--<i class="bi pt-2 bi-chevron-down"></i>--%></a></li>
                        <li class="p-21 px-4"><a class="text-white" href="productview.aspx">View/ Edit Products <%--<i class="bi pt-2 bi-chevron-down"></i>--%></a></li>
                        <li class="p-21 px-4"><a class="text-white" href="">User Management <%--<i class="bi pt-2 bi-chevron-down"></i>--%></a></li>
                        <li class="p-21 px-4"><a class="text-white" href="">Feedback <%--<i class="bi pt-2 bi-chevron-down"></i>--%></a></li>
                        <li class="p-21 px-4"><a class="text-white" href="homepage.aspx">Home </a></li>
                        
                        <%--<li class="p-21 px-4"><a class="text-white" href="">Home </a></li>--%>
                    </ul>
                </div>
            </div>
        </header>
